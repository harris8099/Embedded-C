...
#define GPIO_MODE_IT_FT		4  	// GPIO mode for input falling edge
#define GPIO_MODE_IT_RT		5 	// GPIO mode for rising edge
#define GPIO_MODE_IT_RFT	6 	// GPIO mode for trigger
